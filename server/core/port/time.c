...
static int update_hwtimer (void) {
  ...
  hi = (int)((unsigned long)(ktimer->timer_value >> 32) - (unsigned long)(ctime >> 32));
  low = (int)((unsigned long)(ktimer->timer_value & 0xFFFFFFFF) - (unsigned long)(ctime & 0xFFFFFFFF));

  while (ktimer &&  (( (int)((unsigned long)(ktimer->timer_value >> 32) - (unsigned long)(ctime >> 32)) > 0 ) ||
         ( ( (int)((unsigned long)(ktimer->timer_value >> 32) - (unsigned long)(ctime >> 32)) == 0 ) &&
         ( (int)((unsigned long)(ktimer->timer_value & 0xFFFFFFFF) - (unsigned long)(ctime & 0xFFFFFFFF) ) <= 0 ) ))) {

...
int pthread_create2(pthread_t *thread,
		   const pthread_attr_t *attr,
		   void *(*start_routine)(void *), void *arg) {
  long __res;
  __syscall4 (thread, attr, start_routine, arg, pthread_create2_nr, __res);
...
int pthread_create(pthread_t *thread,
		   ...
		   void *(*start_routine)(void *), void *arg) {
  long __res;
  __syscall5 (thread, attr, startup, start_routine, arg, pthread_create_nr, __res);
  __syscall_return (int,__res);
}
...
int pthread_create_idle(pthread_t *thread,
                   const pthread_attr_t *attr,
                   void *(*start_routine)(void *), void *arg) {
  long __res;
  __syscall4 (thread, attr, start_routine, arg, pthread_create_idle_nr, __res);
  __syscall_return (int,__res);
}
